...
load_model_name=base+'/permute'+'/model-pass-111'
...
y_pred = (1-np.transpose(prediction))
print(y_pred.shape)
y_true = gt
print(y_true.shape)
y_score = (1-np.transpose(prediction_score))

cm = confusion_matrix(y_true, y_pred)
np.save('cm-fin-'+str(pas), cm)
plot_auc(y_true,y_score,'auc-fin-'+str(pas)+'.png')
